...
save(stuck_index, res_Independent_mean, res_Independent_g1_mean, res_Independent_g2_mean, res_Independent_g3_mean, res_Independent_g4_mean, file = "sim_n50_p100_mean_Independent.RData")
save(res_Independent_sd, res_Independent_g1_sd, res_Independent_g2_sd, res_Independent_g3_sd, res_Independent_g4_sd, file = "sim_n50_p100_sd_Independent.RData")
