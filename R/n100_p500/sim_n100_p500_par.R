...
save(stuck_index, res_Coupled_mean, res_Coupled_g1_mean, res_Coupled_g2_mean, res_Coupled_g3_mean, res_Coupled_g4_mean, file = "sim_n100_p500_mean_Coupled.RData")
save(res_Coupled_sd, res_Coupled_g1_sd, res_Coupled_g2_sd, res_Coupled_g3_sd, res_Coupled_g4_sd, file = "sim_n100_p500_sd_Coupled.RData")
...
save(stuck_index, res_Full_mean, res_Full_g1_mean, res_Full_g2_mean, res_Full_g3_mean, res_Full_g4_mean, file = "sim_n100_p500_mean_Full.RData")
save(res_Full_sd, res_Full_g1_sd, res_Full_g2_sd, res_Full_g3_sd, res_Full_g4_sd, file = "sim_n100_p500_sd_Full.RData")
...
save(stuck_index, res_Independent_mean, res_Independent_g1_mean, res_Independent_g2_mean, res_Independent_g3_mean, res_Independent_g4_mean, file = "sim_n100_p500_mean_Independent.RData")
save(res_Independent_sd, res_Independent_g1_sd, res_Independent_g2_sd, res_Independent_g3_sd, res_Independent_g4_sd, file = "sim_n100_p500_sd_Independent.RData")
